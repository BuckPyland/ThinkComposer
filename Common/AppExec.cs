   ...
   public static class AppExec
   {
      ...
      public static void Initialize(string AppName, string AppVersion, string AppDefinitions, string UserDataName)
      {
         ...
         try
         {
            ...
            // In Visual Studio Debug configuration, "<Solution Folder>\PredefinedContent"
#if DEBUG
            ApplicationSpecificDefinitionsDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), @"source\repos\ThinkComposer\PredefinedContent");
#else

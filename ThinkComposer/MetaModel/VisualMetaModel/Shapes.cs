...
// 2020-07-25 Buck Pyland        Added Straight Mid-Horizontal Line shape to (hopefully) use
//                               as a UML Fork/Join symbol.
//
...
namespace Instrumind.ThinkComposer.MetaModel.VisualMetaModel
{
   ...
   public static class Shapes
   {
      ...
      // Added 2020-07-25
      public const string StraightMidHorizLine = "StraightMidHorizLine";
      //
      ...
      static Shapes()
      {
         ...
         // Added 2020-07-25
         PredefinedShapes.Add(new SimplePresentationElement("Straight-MidHorizontal-Line", StraightMidHorizLine, "", SymbolDrawer.CreateSymbol(StraightMidHorizLine, ShapePen, ShapeBrush, ShapeCenter, ShapeWidth, ShapeHeight).Item1.ToDrawingImage()));
         //

...
namespace Instrumind.ThinkComposer.MetaModel
{
   ...
   public abstract class MetaDefinition : FormalPresentationElement, IModelEntity, IModelClass<MetaDefinition>
   {
      ...
      public int MetaId
      {
         get { return __MetaId.Get(this); }
         set { __MetaId.Set(this, value); }
      }

      protected int MetaId_;

      public static readonly ModelPropertyDefinitor<MetaDefinition, int> __MetaId =
         new ModelPropertyDefinitor<MetaDefinition, int>("MetaId",
                                                         EEntityMembership.InternalCoreExclusive,
                                                         null,
                                                         EPropertyKind.Common,
                                                         ins => ins.MetaId_,
                                                         (ins, val) => ins.MetaId_ = val,
                                                         false,
                                                         true,
                                                         "Meta-Id",
                                                         "Simple identifier for indirectly associating created objects with definitions.");

      /// <summary>
      /// Indicates at what level this definition can be changed.
      /// </summary>
      public EAlterability Alterability
      {
         get { return __Alterability.Get(this); }
         set { __Alterability.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<MetaDefinition, EAlterability> __Alterability =
         new ModelPropertyDefinitor<MetaDefinition, EAlterability>("Alterability",
                                                                   EEntityMembership.InternalCoreExclusive,
                                                                   null,
                                                                   EPropertyKind.Common,
                                                                   ins => ins.Alterability_,
                                                                   (ins, val) => ins.Alterability_ = val,
                                                                   false,
                                                                   true,
                                                                   "Alterability",
                                                                   "Indicates at what level this definition can be changed.");
      ...
      public new ModelClassDefinitor<MetaDefinition> ClassDefinitor
      {
         get { return __ClassDefinitor; }
      }
      ...
      public new MetaDefinition CreateClone(ECloneOperationScope CloningScope, IMModelClass DirectOwner, bool AsActive = true)
      {
         return this.ClassDefinitor.PopulateInstance((MetaDefinition)this.MemberwiseClone(), this, DirectOwner, CloningScope, true, AsActive);
      }

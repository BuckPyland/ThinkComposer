...
namespace Instrumind.ThinkComposer.MetaModel.GraphMetaModel
{
   ...
   public class ConceptDefinition : IdeaDefinition, IModelEntity, IModelClass<ConceptDefinition>
   {
      ...
      public static readonly FormalPresentationElement ConceptDef_Cluster_None =
         new FormalPresentationElement("<NONE>", CONDEF_CLUSTER_EMPTY_ID, "");
      ...
      public ConceptDefinition(IdeaDefinition OwnerComposite,
                               ConceptDefinition AncestorConceptDef,
                               string Name,
                               string TechName,
          ...
          : base(OwnerComposite, Name, TechName, RepresentativeShape, Summary, Pictogram)
      {
         ...
         {
            InitialWidth = ApplicationProduct.ProductDirector.DefaultConceptBodySymbolSize.Width,
            InitialHeight = ApplicationProduct.ProductDirector.DefaultConceptBodySymbolSize.Height
         };
      ...
      /// </summary>
      public ConceptDefinition AncestorConceptDef
      {
         get { return __AncestorConceptDef.Get(this); }
         set { __AncestorConceptDef.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<ConceptDefinition, ConceptDefinition> __AncestorConceptDef =
         new ModelPropertyDefinitor<ConceptDefinition, ConceptDefinition>("AncestorConceptDef",
                                                                           EEntityMembership.External,
                                                                           null,
                                                                           EPropertyKind.Common,
                                                                           ins => ins.AncestorConceptDef_,
                                                                           (ins, val) => ins.AncestorConceptDef_ = val,
                                                                           false,
                                                                           true,
                                                                           "Ancestor Concept Definition",
                                                                           "References the ancestor Concept definition of this one.");

      public override IdeaDefinition AncestorIdeaDef
      {
         get { return this.AncestorConceptDef; }
      }
      ...
      public static readonly ModelPropertyDefinitor<ConceptDefinition, ConceptDefinition> __AutomaticCreationConceptDef =
         new ModelPropertyDefinitor<ConceptDefinition, ConceptDefinition>("AutomaticCreationConceptDef",
                                                                          EEntityMembership.External,
                                                                          null,
                                                                          EPropertyKind.Common,
                                                                          ins => ins.AutomaticCreationConceptDef_,
                                                                          (ins, val) => { ins.AutomaticCreationConceptDef_ = val; }, false, false,
                                                                          "Automatic Creation Definition of Concept to Create",
                                                                          "Definition of the Concept to be automatically created.");
      ...
      public static readonly ModelPropertyDefinitor<ConceptDefinition, RelationshipDefinition> __AutomaticCreationRelationshipDef =
         new ModelPropertyDefinitor<ConceptDefinition, RelationshipDefinition>("AutomaticCreationRelationshipDef",
                                                                               EEntityMembership.External,
                                                                               null,
                                                                               EPropertyKind.Common,
                                                                               ins => ins.AutomaticCreationRelationshipDef_,
                                                                               (ins, val) => ins.AutomaticCreationRelationshipDef_ = val,
                                                                               false,
                                                                               false,
                                                                               "Automatic Creation Associating Relationship Definition",
                                                                               "Definition of the Relationship to associate Concepts with the automatically created ones.");

      /// <summary>
      /// Indicates the ways to accommodate the symbols of automatically created Concepts.
      /// </summary>
      ...
      public static readonly ModelPropertyDefinitor<ConceptDefinition, EAutoPositioningMode> __AutomaticCreationPositioningMode =
         new ModelPropertyDefinitor<ConceptDefinition, EAutoPositioningMode>("AutomaticCreationPositioningMode",
                                                                             EEntityMembership.InternalCoreExclusive,
                                                                             null,
                                                                             EPropertyKind.Common,
                                                                             ins => ins.AutomaticCreationPositioningMode_,
                                                                             (ins, val) => ins.AutomaticCreationPositioningMode_ = val,
                                                                             false,
                                                                             false,
                                                                             "Automatic Creation Positioning Mode",
                                                                             "Indicates the ways to accommodate the symbols of automatically created Concepts.");
      ...
      public static readonly ModelPropertyDefinitor<ConceptDefinition, bool> __AutomaticCreationPositioningIsRadialized =
         new ModelPropertyDefinitor<ConceptDefinition, bool>("AutomaticCreationPositioningIsRadialized",
                                                             EEntityMembership.InternalCoreExclusive,
                                                             null,
                                                             EPropertyKind.Common,
                                                             ins => ins.AutomaticCreationPositioningIsRadialized_,
                                                             (ins, val) => ins.AutomaticCreationPositioningIsRadialized_ = val,
                                                             false,
                                                             false,
                                                             "Automatic Creation Positioning Is Radial",
                                                             "Indicates to position automatically created Concepts around in a radial (semi elliptical) style.");
      ...
      public new ModelClassDefinitor<ConceptDefinition> ClassDefinitor
      {
         get { return __ClassDefinitor; }
      }
      ...
      public new ConceptDefinition CreateClone(ECloneOperationScope CloningScope, IMModelClass DirectOwner, bool AsActive = true)
      {
         return this.ClassDefinitor.PopulateInstance((ConceptDefinition)this.MemberwiseClone(), this, DirectOwner, CloningScope, true, AsActive);
      }
      
      public ConceptDefinition PopulateFrom(ConceptDefinition SourceElement, IMModelClass DirectOwner = null, ECloneOperationScope CloningScope = ECloneOperationScope.Slight, params string[] MemberNames)
      {

...
namespace Instrumind.ThinkComposer.MetaModel.GraphMetaModel
{
   ...
   public class RelationshipDefinition : IdeaDefinition, IModelEntity, IModelClass<RelationshipDefinition>
   {
      ...
      public static readonly FormalPresentationElement RelationshipDef_Cluster_None =
         new FormalPresentationElement("<NONE>", RELDEF_CLUSTER_EMPTY_ID, "");
      ...
      static RelationshipDefinition()
      {
         ...
         __ClassDefinitor = new ModelClassDefinitor<RelationshipDefinition>("RelationshipDefinition",
      ...
      public RelationshipDefinition(IdeaDefinition OwnerComposite,
                                    RelationshipDefinition AncestorRelationshipDef,
                                    string Name,
                                    string TechName,
                                    string RepresentativeShape,
                                    string Summary = "",
                                    ImageSource Pictogram = null,
                                    LinkRoleDefinition OriginOrParticipantLinkRoleDef = null,
                                    LinkRoleDefinition TargetLinkRoleDef = null)
          : base(OwnerComposite, Name, TechName, RepresentativeShape, Summary, Pictogram)
      {
         ...
         // This is at the bottom, because it requires link-roles to be defined
         ...
         this.DefaultConnectorsFormat = new VisualConnectorsFormat(this.OwnerDomain.LinkRoleVariants.First(), Plugs.None,
                                                                   this.OwnerDomain.LinkRoleVariants.First(), Plugs.SimpleArrow,
                                                                   Brushes.Black);
      }
      ...
      {
         get { return base.Pictogram.NullDefault(this.DefaultPictogram); }
      ...
      /// </summary>
      public override ImageSource DefaultPictogram
      {
         get { return PredefinedDefaultPictogram; }
      }
      ...
      /// </summary>
      public RelationshipDefinition AncestorRelationshipDef
      {
         get { return __AncestorRelationshipDef.Get(this); }
         set { __AncestorRelationshipDef.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, RelationshipDefinition> __AncestorRelationshipDef =
         new ModelPropertyDefinitor<RelationshipDefinition, RelationshipDefinition>("AncestorRelationshipDef",
                                                                                    EEntityMembership.External,
                                                                                    null,
                                                                                    EPropertyKind.Common,
                                                                                    ins => ins.AncestorRelationshipDef_,
                                                                                    (ins, val) => ins.AncestorRelationshipDef_ = val,
                                                                                    false,
                                                                                    true,
                                                                                    "Ancestor Relationship Definition",
                                                                                    "References the ancestor Relationship definition of this one.");
      public override IdeaDefinition AncestorIdeaDef
      {
         get { return this.AncestorRelationshipDef; }
      }
      ...
      {
         get { return __IsDirectional.Get(this); }
         set { __IsDirectional.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, bool> __IsDirectional =
         new ModelPropertyDefinitor<RelationshipDefinition, bool>("IsDirectional",
                                                                  EEntityMembership.InternalCoreExclusive,
                                                                  null,
                                                                  EPropertyKind.Common,
                                                                  ins => ins.IsDirectional_,
                                                                  (ins, val) => ins.IsDirectional_ = val,
                                                                  true,
                                                                  false,
                                                                  "Is Directional",
                                                                  "Indicates whether this relationship if from an origin to a target, else is between equivalent participants.");
      ...
      /// </summary>
      public LinkRoleDefinition OriginOrParticipantLinkRoleDef
      {
         get { return __OriginOrParticipantLinkRoleDef.Get(this); }
         set { __OriginOrParticipantLinkRoleDef.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, LinkRoleDefinition> __OriginOrParticipantLinkRoleDef =
         new ModelPropertyDefinitor<RelationshipDefinition, LinkRoleDefinition>("OriginOrParticipantLinkRoleDef",
                                                                                EEntityMembership.InternalCoreExclusive,
                                                                                null,
                                                                                EPropertyKind.Common,
                                                                                ins => ins.OriginOrParticipantLinkRoleDef_,
                                                                                (ins, val) => ins.OriginOrParticipantLinkRoleDef_ = val,
                                                                                true,
                                                                                false,
                                                                                "Origin Or Participant Link Role Definition",
                                                                                "Definition for the Origin/Source link role. This is the participant role in a non-directional relationship.");

      /// <summary>
      /// Definition for the Target/Destination link role. This has no use in a non-directional relationship.
      /// </summary>
      public LinkRoleDefinition TargetLinkRoleDef
      {
         get { return __TargetLinkRoleDef.Get(this); }
         set { __TargetLinkRoleDef.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, LinkRoleDefinition> __TargetLinkRoleDef =
         new ModelPropertyDefinitor<RelationshipDefinition, LinkRoleDefinition>("TargetLinkRoleDef",
                                                                                EEntityMembership.InternalCoreExclusive,
                                                                                null,
                                                                                EPropertyKind.Common,
                                                                                ins => ins.TargetLinkRoleDef_,
                                                                                (ins, val) => ins.TargetLinkRoleDef_ = val,
                                                                                true,
                                                                                false,
                                                                                "Target Link Role Definition",
                                                                                "Definition for the Target/Destination link role. This has no use in a non-directional relationship.");

      /// <summary>
      /// Format to be initially applied to the related visual connectors.
      /// </summary>
      public VisualConnectorsFormat DefaultConnectorsFormat
      {
         get { return __DefaultConnectorsFormat.Get(this); }
         set { __DefaultConnectorsFormat.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, VisualConnectorsFormat> __DefaultConnectorsFormat =
         new ModelPropertyDefinitor<RelationshipDefinition, VisualConnectorsFormat>("DefaultConnectorsFormat",
                                                                                    EEntityMembership.InternalCoreExclusive,
                                                                                    null,
                                                                                    EPropertyKind.Common,
                                                                                    ins => ins.DefaultConnectorsFormat_,
                                                                                    (ins, val) => ins.DefaultConnectorsFormat_ = val,
                                                                                    false,
                                                                                    false,
                                                                                    "Default Connectors Format",
                                                                                    "Format to be initially applied to the related visual connectors.");

      /// <summary>
      /// Indicates that the relationship can only be established between one source and one target.
      /// </summary>
      public bool IsSimple
      {
         get { return __IsSimple.Get(this); }
         set { __IsSimple.Set(this, value); }
      }
      
      protected bool IsSimple_ = false;
      
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, bool> __IsSimple =
         new ModelPropertyDefinitor<RelationshipDefinition, bool>("IsSimple",
                                                                  EEntityMembership.InternalCoreExclusive,
                                                                  null,
                                                                  EPropertyKind.Common,
                                                                  ins => ins.IsSimple_,
                                                                  (ins, val) => ins.IsSimple_ = val,
                                                                  false,
                                                                  false,
                                                                  "Is Simple",
                                                                  "Indicates that the relationship can only be established between one source and one target.");
      ...
      /// <summary>
      /// Hides the Central/Main Symbol for a simple relationship, if possible.
      /// </summary>
      public bool HideCentralSymbolWhenSimple
      {
         get { return __HideCentralSymbolWhenSimple.Get(this); }
         set { __HideCentralSymbolWhenSimple.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, bool> __HideCentralSymbolWhenSimple =
         new ModelPropertyDefinitor<RelationshipDefinition, bool>("HideCentralSymbolWhenSimple",
                                                                  EEntityMembership.InternalCoreExclusive,
                                                                  null,
                                                                  EPropertyKind.Common,
                                                                  ins => ins.HideCentralSymbolWhenSimple_,
                                                                  (ins, val) => ins.HideCentralSymbolWhenSimple_ = val,
                                                                  false,
                                                                  false,
                                                                  "Hide Central/Main-Symbol When Simple",
                                                                  "Hides the Central/Main Symbol for a simple relationship, if possible.");

      /// <summary>
      /// Indicates to show Relationship name when hiding the Central/Main Symbol.
      /// </summary>
      public bool ShowNameIfHidingCentralSymbol
      {
         get { return __ShowNameIfHidingCentralSymbol.Get(this); }
         set { __ShowNameIfHidingCentralSymbol.Set(this, value); }
      }
      ...
      public static readonly ModelPropertyDefinitor<RelationshipDefinition, bool> __ShowNameIfHidingCentralSymbol =
         new ModelPropertyDefinitor<RelationshipDefinition, bool>("ShowNameIfHidingCentralSymbol",
                                                                  EEntityMembership.InternalCoreExclusive,
                                                                  null,
                                                                  EPropertyKind.Common,
                                                                  ins => ins.ShowNameIfHidingCentralSymbol_,
                                                                  (ins, val) => ins.ShowNameIfHidingCentralSymbol_ = val,
                                                                  false,
                                                                  false,
                                                                  "Show Name If Hiding Central/Main-Symbol",
                                                                  "Indicates to show the Relationship name when hiding the Central/Main Symbol.");
      ...
      /// considering its linking role's associability, variants and multiconnectability.
      /// </summary>
      public OperationResult<bool> CanLink(IdeaDefinition OriginIdea,
                                           IdeaDefinition TargetIdea,
                                           SimplePresentationElement OriginVariant = null,
                                           SimplePresentationElement TargetVariant = null)
      {
         ...
         if (!ValidateMultiConnectability(OriginIdea, TargetIdea))
            return OperationResult.Failure<bool>("A non-multiconnectable role is already being used.");
...
#pragma warning disable IDE0060 // Remove unused parameter
      /// <summary>
      /// Validates that variants are valid for the intended link.
      /// </summary>
      /// <param name="OriginIdea">Origin of the intended link</param>
      /// <param name="OriginVariant">Variant to be applied to the link's Origin</param>
      /// <param name="TargetIdea">Target of the intended link</param>
      /// <param name="TargetVariant">Variant to be applied to the link's Target</param>
      /// <returns></returns>
...
#pragma warning restore IDE0060 // Remove unused parameter
      ...
      public new MModelClassDefinitor ClassDefinition
      {
         get { return __ClassDefinitor; }
      }
      
      public new ModelClassDefinitor<RelationshipDefinition> ClassDefinitor
      {
         get { return __ClassDefinitor; }
      }
      ...
      public RelationshipDefinition PopulateFrom(RelationshipDefinition SourceElement,
